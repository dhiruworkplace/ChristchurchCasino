...
public class Screenshoter : MonoBehaviour
{
    ...
    //CameraExtra c;
    //public CameraExtra C
    //{
    //    get
    //    {
    //        if (c == null)
    //        {
    //            c = FindObjectOfType<CameraExtra>();
    //        }
    //        return c;
    //    }
    //}
    ...
    IEnumerator IEApplyResolution(Resolution r)
    {
        ...
        //Camera.main.GetComponent<CameraController>().Resize();
    ...
    IEnumerator CaptureRoutine()
    {
        ...
        foreach (var r in resolutions)
        {
            ...
            yield return null;
            //Camera.main.GetComponent<CameraController>().Resize();
            //Camera.main.GetComponentInChildren<FillToScreen>().ResizeSpriteToScreen();
            yield return null;
    ...
    public static int FindViewSize(GameViewSizeGroupType sizeGroupType, int width, int height, string name)
    {
        ...
        for (int i = 0; i < sizesCount; i++)
        {
            ...
            if (sizeWidth == width && sizeHeight == height && name == text)
                return i;
        }
        return -1;
    }
