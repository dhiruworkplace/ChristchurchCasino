...
public class HomeChrist : MonoBehaviour
{
    ...
    {
        Game.Instance.coins = 0;
        levelNo.text = "Level " + AppChrist.selectedLevel.ToString("00");
        levelsPanel.SetActive(false);
        AppChrist.isLevels = true;
        GameManager.Instance.StartGame();
